...
class FlingSettingsPageTest {
  ...
  fun flingSettingsNativeRadioButtonRendered() {
    launchInitialActivity()
    composeAndroidTestRule.apply { onNodeWithTag("native").assertIsDisplayed() }
  }
  ...
  fun flingSettingsNativeRadioButtonClick() {
    ...
    composeAndroidTestRule.apply {
      onNodeWithTag("native").performClick()
      onNodeWithTag(TestTags.HOME_FLING_SETTINGS_EDITABLE).assertDoesNotExist()
    }
  }
  ...
  fun flingSettingsSmoothRadioButtonRendered() {
    launchInitialActivity()
    composeAndroidTestRule.apply { onNodeWithTag("smooth").assertIsDisplayed() }
  }
  ...
  fun flingSettingsSmoothRadioButtonClick() {
    launchInitialActivity()
    composeAndroidTestRule.apply {
      onNodeWithTag("smooth").performClick()
      onNodeWithTag(TestTags.HOME_FLING_SETTINGS_EDITABLE).assertDoesNotExist()
    }
  }
  ...
  fun flingSettingsCustomRadioButtonRendered() {
    launchInitialActivity()
    composeAndroidTestRule.apply { onNodeWithTag("custom").assertIsDisplayed() }
  }
  ...
  fun flingSettingsCustomRadioButtonClick() {
    ...
    composeAndroidTestRule.apply {
      ...
      onNodeWithTag(TestTags.HOME_FLING_SETTINGS_EDITABLE).assertIsDisplayed()
    }
  }
  ...
  fun flingSettingsApplyButtonWithNativeSelection() {
    ...
    composeAndroidTestRule.apply {
      ...
      onNodeWithTag(TestTags.HOME_FLING_SETTINGS_APPLY).assertIsDisplayed()

      onNodeWithTag(TestTags.HOME_FLING_SETTINGS_APPLY).performClick()

      onNodeWithTag(TestTags.HOME_FLING_HEADER).assertIsDisplayed()
