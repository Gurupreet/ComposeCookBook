...
internal class HomeScreenItemsTest {
  ...
  fun `Home Screen Entry ListView name must contain its type`() {
    ...
    assertThat(verticalListViewItem.name).contains(verticalListViewItem.type)
  }

  @Test
  fun `Default Home Screen Entry ListView type should be Vertical`() {
    val verticalListViewItem = HomeScreenItems.ListView()
    assertThat(verticalListViewItem.type).isEqualTo("Vertical")
  }

  @Test
  fun `Provided Home Screen Items must contain 3 entries for ListViews`() {
    assertThat(DemoDataProvider.homeScreenListItems.filterIsInstance<HomeScreenItems.ListView>())
      .hasSize(3)
  }

  @Test
  fun `Provided Home Screen Items must contain at list an entry for Dialogs`() {
    assertThat(DemoDataProvider.homeScreenListItems.filterIsInstance<HomeScreenItems.Dialogs>())
      .isNotEmpty()
  }

  @Test
  fun `Provided Home Screen Items must contain at list an entry for Layouts`() {
    assertThat(DemoDataProvider.homeScreenListItems.filterIsInstance<HomeScreenItems.Layouts>())
      .isNotEmpty()
  }

  @Test
  fun `Provided Home Screen Items must contain at list an entry for Modifiers`() {
    assertThat(DemoDataProvider.homeScreenListItems.filterIsInstance<HomeScreenItems.Modifiers>())
      .isNotEmpty()
  }
  ...
  fun `Provided Home Screen Items must contain at list an entry for Advanced Lists`() {
    assertThat(
        DemoDataProvider.homeScreenListItems.filterIsInstance<HomeScreenItems.AdvanceLists>()
      )
      .isNotEmpty()
  }
  ...
  fun `Provided Home Screen Items must contain at list an entry for Android Views`() {
    assertThat(
        DemoDataProvider.homeScreenListItems.filterIsInstance<HomeScreenItems.AndroidViews>()
      )
      .isNotEmpty()
  }
  ...
  fun `Provided Home Screen Items must contain at list an entry for Carousel`() {
    assertThat(DemoDataProvider.homeScreenListItems.filterIsInstance<HomeScreenItems.Carousel>())
      .isNotEmpty()
  }
  ...
  fun `Provided Home Screen Items must contain at list an entry for ConstraintsLayout`() {
    assertThat(
        DemoDataProvider.homeScreenListItems.filterIsInstance<HomeScreenItems.ConstraintsLayout>()
      )
      .isNotEmpty()
  }
  ...
  fun `Provided Home Screen Items must contain at list an entry for TabLayout`() {
    assertThat(DemoDataProvider.homeScreenListItems.filterIsInstance<HomeScreenItems.TabLayout>())
      .isNotEmpty()
  }
  ...
  fun `Provided Home Screen Items must contain at list an entry for BottomSheets`() {
    assertThat(
        DemoDataProvider.homeScreenListItems.filterIsInstance<HomeScreenItems.BottomSheets>()
      )
      .isNotEmpty()
  }
  ...
  fun `Provided Home Screen Items must contain at list an entry for PullRefresh`() {
    assertThat(DemoDataProvider.homeScreenListItems.filterIsInstance<HomeScreenItems.PullRefresh>())
      .isNotEmpty()
  }
}
