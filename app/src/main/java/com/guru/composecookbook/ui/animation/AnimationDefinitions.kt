...
//        MutableTransitionState(AnimationState.START).apply { targetState = AnimationState.END }
//    }
//
//    val colorTransition = updateTransition(targetState = currentState)
//    val colorAnim by colorTransition.animateColor { progress ->
//        if (progress == AnimationState.START) {
//            Color.Green
//        } else if (progress == AnimationState.MID) {
//            Color.Blue
//        } else {
//            Color.Cyan
//        }
