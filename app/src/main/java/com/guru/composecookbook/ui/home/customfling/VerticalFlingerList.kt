 ...
 * @param onSettingsClick: Used to do a callback to the parent function that launches the settings
 *   activity.
...
fun VerticalFlingerListView(
  ...
  Column(modifier = modifier) {
    Column(
      modifier = Modifier.fillMaxWidth().padding(16.dp).testTag(TestTags.HOME_FLING_LIST_BUTTON)
    ) {
