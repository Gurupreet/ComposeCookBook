...
fun TypeOfBoxs() {
  ...
  Box(modifier = boxModifier.testTag(TestTags.HOME_LAYOUTS_BOX_NO_ALIGN)) {
    ...
    Material3Card(backgroundColor = green500, elevation = 4.dp, modifier = Modifier.size(150.dp)) {}
    Material3Card(backgroundColor = green200, elevation = 4.dp, modifier = Modifier.size(100.dp)) {}
  }
  Text(
