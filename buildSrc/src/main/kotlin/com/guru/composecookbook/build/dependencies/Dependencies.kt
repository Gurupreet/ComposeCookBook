...
object Dependencies {
    ...
    const val composeViewModel = "androidx.lifecycle:lifecycle-viewmodel-compose:${Versions.lifecycleViewModelCompose}"
    ...
    const val coilAccompanist = "com.google.accompanist:accompanist-coil:${Versions.accompanistCoil}"
    ...
    const val okHttpGsonConverter = "com.squareup.retrofit2:converter-gson:${Versions.retrofitConverterGson}"
    ...
    const val lifecycleExtensions = "androidx.lifecycle:lifecycle-extensions:${Versions.androidLifecycleGrouped}"
    const val liveDataKtx = "androidx.lifecycle:lifecycle-livedata-ktx:${Versions.androidLifecycleGrouped}"
    const val viewModelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:${Versions.androidLifecycleGrouped}"
