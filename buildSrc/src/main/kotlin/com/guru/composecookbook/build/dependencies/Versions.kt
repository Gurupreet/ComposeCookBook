...
internal object Versions {
    ...
    const val retrofitConverterGson = "2.9.0"  // Latest stable
    const val multidex = "2.0.1"  // No new versions expected
    const val junitJupiterApi = "5.10.1"  // Latest stable
    const val junitJupiterEngine = "5.10.1"  // Latest stable
    const val truth = "1.1.3"  // Latest stable
    const val androidXJunit = "1.1.5"  // Latest stable
    const val biometric = "1.2.0-alpha05"  // Latest stable
}
