package com.guru.composecookbook.theme.helpers
...
object TextFieldDefaultsMaterial {
  ...
  fun textFieldColors(
    ...
    leadingIconColor: Color = MaterialTheme.colorScheme.onSurface.copy(alpha = IconOpacity),
    disabledLeadingIconColor: Color = leadingIconColor.copy(alpha = ContentAlpha.disabled),
    errorLeadingIconColor: Color = leadingIconColor,
    trailingIconColor: Color = MaterialTheme.colorScheme.onSurface.copy(alpha = IconOpacity),
