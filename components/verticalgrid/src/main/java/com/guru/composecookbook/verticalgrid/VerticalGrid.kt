...
/**
 * Taken from Jetsnack sample. Right now there is no inbuilt grid but we can make Custom layout like
 * below which takes number of items and place them in Grid fashion.
 *
