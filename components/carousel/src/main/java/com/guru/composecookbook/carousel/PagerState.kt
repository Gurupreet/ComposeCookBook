...
/** This is a modified version of: https://gist.github.com/adamp/07d468f4bcfe632670f305ce3734f511 */
...
class PagerState(currentPage: Int = 0, minPage: Int = 0, maxPage: Int = 0) {
  ...
  private var _currentPageOffset = Animatable(0f).apply { updateBounds(-1f, 1f) }
