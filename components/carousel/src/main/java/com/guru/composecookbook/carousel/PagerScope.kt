...
class PagerScope(private val state: PagerState, val commingPage: Int) {
  ...
  /**
   * Modifier which scales pager items according to their offset position. Similar in effect to a
   * carousel.
   */
